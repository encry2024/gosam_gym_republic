    ...
    */
    ...
    'backend' => [
        ...
        'activities' => [
            ...
            'restore_activity_confirm' => 'Restore this activity to its original state?',
        ],

        'coaches' => [
            'delete_coach_confirm' => 'Are you sure you want to delete this coach permanently? Anywhere in the application that references this coach\'s id will most likely error. Proceed at your own risk. This can not be un-done.',
            'no_deleted' => 'There are no deleted coaches.',
            'restore_coach_confirm' => 'Restore this coach to its original state?',
        ],
