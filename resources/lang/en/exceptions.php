...
return [
    ...
    */
    ...
    'backend' => [
        'memberships' => [
            'create_error' => 'There was a problem registering Customer ":customer" to Membership. Please try again.',
            'delete_error' => 'There was a problem deleting Membership ":membership". Please try again.',
            'not_found' => 'Membership ":membership" does not exist.',
            'update_error' => 'There was a problem updating membership ":membership". Please try again.',
        ],

        'customers' => [
            'already_exists' => 'Customer ":customer" already exists. Please choose a different name.',
            'create_error' => 'There was a problem creating customer ":customer". Please try again.',
            'delete_error' => 'There was a problem deleting customer ":customer". Please try again.',
            'not_found' => 'Customer ":customer" does not exist.',
            'update_error' => 'There was a problem updating customer ":customer". Please try again.',
        ],

        'activities' => [
            'already_exists' => 'Activity ":activity" already exists. Please choose a different name.',
            'create_error' => 'There was a problem creating activity ":activity". Please try again.',
            'delete_error' => 'There was a problem deleting activity ":activity". Please try again.',
            'not_found' => 'Activity ":activity" does not exist.',
            'update_error' => 'There was a problem updating activity ":activity". Please try again.',
        ],

        'coaches' => [
            'already_exists' => 'That coach ":coach" already exists. Please choose a different name.',
            'cant_restore' => 'Coach ":coach" is not deleted so it can not be restored.',
            'create_error' => 'There was a problem creating coach ":coach". Please try again.',
            'delete_error' => 'There was a problem deleting coach ":coach". Please try again.',
            'not_found' => 'That coach ":coach" does not exist.',
            'update_error' => 'There was a problem updating coach ":coach". Please try again.',
        ],
