...
@section('title', __('labels.backend.activities.management') . ' | ' . __('labels.backend.activities.edit'))
...
@section('content')
    {{ html()->modelForm($activity, 'PATCH', route('admin.activity.update', $activity))->class('form-horizontal')->open() }}
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-5">
                        <h4 class="card-title mb-0">
                            ...
                            <small class="text-muted">@lang('labels.backend.activities.edit')</small>
                        </h4>
                    </div><!--col-->
                </div><!--row-->
